...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        # --- 1. 윈도우 기본 설정 ---
        self.setWindowTitle("DPS DL-01 Setup Program")
        ...
        # --- 설정 초기화 ---
        self.settings = QSettings("DPSDL", "DPSDL-Setup")
        ...
        saved_client_ip = self.settings.value("allowed_client_ip", "192.168.0.62")
